...
import { uploadEntryFiles } from '../../middleware/upload.middleware';
...
router.post('/entry', uploadEntryFiles, createEntryValidators, validate, (req, res, next) => conglomeradoController.createEntry(req, res, next));
